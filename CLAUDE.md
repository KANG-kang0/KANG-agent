...
進行中規劃（2026-07 定案，動手前先讀）：小書蟲儲值＝`小書蟲/規劃-儲值與訂閱.md`、產品路線＝`小書蟲/規劃-產品路線.md`；短線衛兵風控＝`短線衛兵-worker/規劃-風控版面.md`（連同`判斷-話術責任邊界.md`）；零錢種子×衛兵互通＝`撲滿/規劃-與短線衛兵資料互通.md`。動零錢種子的策略/回測前，必讀`撲滿/判斷-回測可信度.md`。
